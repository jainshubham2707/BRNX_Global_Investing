 ...
 * Simulates the admin verifying the bank transfer and executing both TXs.
 * Flow of funds is identical to /api/admin/approve-instant-pay.
 */
export async function POST(req: NextRequest) {
  try {
    ...
    if (user.privyId !== privyUser.id) return NextResponse.json({ error: "Unauthorized" }, { status: 403 });
    ...
    console.error("POST /api/auto-approve-instant-pay error:", error);
